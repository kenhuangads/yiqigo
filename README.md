...
| 🖼️ **照片翻譯** | 上傳／拖曳／貼上照片（菜單、藥妝成分表、文件截圖），整頁辨識翻譯成繁體中文。啟用 AI 引擎後改由 **Gemini 視覺模型**單次完成辨識＋翻譯——手寫字、藝術字體、複雜背景、直式排版都穩，並自動修正 iPhone 照片方向。 |
| 📖 **旅遊句庫** | 7 大情境 × **111 句**人工校對的四語常用句（基本、交通、點餐、購物、住宿、緊急、實用），以當地人日常口語＋合宜禮貌為標準撰寫，**完全離線可用**，點一句即可全螢幕展示＋朗讀。 |
